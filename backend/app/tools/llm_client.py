"""Generic LLM client — compatible with any OpenAI-format chat completions API.
...
class LLMClient:
    """Synchronous client for OpenAI-compatible /v1/chat/completions endpoints."""
    ...
    def chat_json(
        ...
        *,
        ...
        # Some providers don't support response_format; try parsing anyway
        try:
