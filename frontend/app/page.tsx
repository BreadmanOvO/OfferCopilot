...
export default function HomePage() {
  ...
  return (
    ...
    >
      <h1 style={{ fontSize: "2.5rem", marginBottom: "0.5rem" }}>OfferCopilot</h1>
      ...
      >
        ...
        >
          ...
          <h2 style={{ color: "#3b82f6", fontSize: "1.4rem", marginBottom: "0.75rem" }}>
            意向推荐
          </h2>
        ...
        >
          <div style={{ fontSize: "3rem", marginBottom: "1rem" }}>📋</div>
          <h2 style={{ color: "#10b981", fontSize: "1.4rem", marginBottom: "0.75rem" }}>
            直接分析
          </h2>
          <p style={{ color: "#555", fontSize: "1rem", lineHeight: 1.6, margin: 0 }}>
